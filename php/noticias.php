...
class Noticia
{
  ...
  public function getAllNoticia()
  {
    ...
    try
    {
      ...
      $query      = $Conexao->query("SELECT * FROM noticia");
      ...
      if(!empty($noticia_list))
      {
        foreach ($noticia_list as $row => $noticia) {
          if(empty(!$noticia['descricao']))
          {
            $noticias .=
            '<div class="col-md-3">
              <div class="card mb-3 shadow-sm">
                <img class="card-img-top" src="http://127.0.0.1/estagio%20web/imagens/img_avatar1.png" alt="Card image cap">
